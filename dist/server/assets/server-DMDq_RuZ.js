...
import { n as createCsrfMiddleware, r as csrfSymbol } from "./createStart-7t-l87AE.js";
import "react";
...
import { createRawStreamRPCPlugin, createSerializationAdapter, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, isNotFound, isRedirect as isRedirect$1, isResolvedRedirect, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B-mhouwc.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bwu8iuIG.js"),
		import("./start-BaZn0J-F.js"),
