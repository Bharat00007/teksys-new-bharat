...
//#region src/assets/service-gan.jpg
var service_gan_default = "/assets/service-gan-2rnyE2UT.jpg";
//#endregion
//#region src/assets/service-sic.jpg
var service_sic_default = "/assets/service-sic-3ivsNZI-.jpg";
//#endregion
//#region src/assets/service-rf.jpg
var service_rf_default = "/assets/service-rf-Cp6PVTmO.jpg";
//#endregion
//#region src/lib/site.ts
var SITE = {
	name: "TEKSYS",
	tagline: "Innovate · Train · Transform",
	description: "Semiconductor, Defence & Advanced Technology Solutions — GaN/SiC consulting, fabless MMIC design, and a semiconductor skill training academy.",
...
var SERVICES = [
	{
		...
		icon: "Cpu",
		image: service_gan_default,
		summary: "End-to-end Gallium Nitride consulting — device physics, RF power amplifier design, qualification and tech transfer for defence, telecom and power applications.",
		bullets: [
	...
	},
	{
		...
		icon: "Zap",
		image: service_sic_default,
		summary: "Silicon Carbide solutions for EV, renewable and high-voltage industrial systems — from device selection to packaged power module design.",
		bullets: [
	...
	},
	{
		...
		icon: "Layers",
		image: service_rf_default,
		summary: "Full fabless flow for GaN/GaAs MMICs — from specification and schematic to layout, foundry tape-out and on-wafer characterization.",
		bullets: [
	...
	},
	{
		...
		icon: "GraduationCap",
		image: service_gan_default,
		summary: "Industry-led semiconductor workforce development on GaN, SiC, RF, sensors, materials and advanced systems — delivered globally with TechDataX certification.",
		bullets: [
	...
	},
	{
		...
		icon: "Wrench",
		image: service_rf_default,
		summary: "Technology computing, device simulation, characterization and engineering support for industry, academia, startups and government programs.",
		bullets: [
	...
	},
	{
		...
		icon: "Microscope",
		image: service_sic_default,
		summary: "Access to OSAT, packaging and process labs through our partner ecosystem — for prototyping, qualification and small-volume builds.",
		bullets: [
...
var COURSES = [
	{
		...
		overview: "Build a strong understanding of semiconductor materials, devices, fabrication processes, testing and industry fundamentals.",
		outcomes: [
	...
	},
	{
		...
		overview: "Learn Gallium Nitride device technology for next-generation RF, radar, telecom, defence and power electronics applications.",
		outcomes: [
	...
	},
	{
		...
		overview: "Master Silicon Carbide materials, devices and power systems used in EVs, renewable energy and high-voltage applications.",
		outcomes: [
	...
	},
	{
		...
		overview: "Explore RF circuits, antennas, power amplifiers, radar systems and wireless communication technologies.",
		outcomes: [
	...
	},
	{
		...
		overview: "Develop expertise in semiconductor sensors, MEMS, IoT systems, industrial monitoring and smart applications.",
		outcomes: [
	...
	},
	{
		...
		overview: "Understand modern power conversion systems using Silicon, GaN and SiC technologies for energy-efficient applications.",
		outcomes: [
	...
	},
	{
		...
		overview: "Study semiconductor materials, thin films, fabrication processes, characterization techniques and emerging electronic materials.",
		outcomes: [
	...
	},
	{
		...
		overview: "Gain system-level knowledge covering packaging, testing, reliability, RF systems, power systems and semiconductor product development.",
		outcomes: [
...
//#endregion
export { SITE as a, SERVICES as i, COURSES as n, service_rf_default as o, NAV as r, service_gan_default as s, cn as t };
